...
${OBJECTDIR}/src/ControlRobot.o: src/ControlRobot.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ControlRobot.o src/ControlRobot.cpp

${OBJECTDIR}/src/Ejemplo.o: src/Ejemplo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Ejemplo.o src/Ejemplo.cpp

${OBJECTDIR}/src/IRobotConnection.o: src/IRobotConnection.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IRobotConnection.o src/IRobotConnection.cpp

${OBJECTDIR}/src/IRobotInstructionSet.o: src/IRobotInstructionSet.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IRobotInstructionSet.o src/IRobotInstructionSet.cpp

${OBJECTDIR}/src/Instruction.o: src/Instruction.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Instruction.o src/Instruction.cpp

${OBJECTDIR}/src/Laberinto.o: src/Laberinto.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Laberinto.o src/Laberinto.cpp

${OBJECTDIR}/src/Principal.o: src/Principal.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Principal.o src/Principal.cpp

${OBJECTDIR}/src/Serial.o: src/Serial.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Serial.o src/Serial.cpp

${OBJECTDIR}/src/Sigue_linea.o: src/Sigue_linea.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Sigue_linea.o src/Sigue_linea.cpp

${OBJECTDIR}/src/tinyxml/tinystr.o: src/tinyxml/tinystr.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tinyxml
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tinyxml/tinystr.o src/tinyxml/tinystr.cpp

${OBJECTDIR}/src/tinyxml/tinyxml.o: src/tinyxml/tinyxml.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tinyxml
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tinyxml/tinyxml.o src/tinyxml/tinyxml.cpp

${OBJECTDIR}/src/tinyxml/tinyxmlerror.o: src/tinyxml/tinyxmlerror.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tinyxml
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tinyxml/tinyxmlerror.o src/tinyxml/tinyxmlerror.cpp

${OBJECTDIR}/src/tinyxml/tinyxmlparser.o: src/tinyxml/tinyxmlparser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/tinyxml
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tinyxml/tinyxmlparser.o src/tinyxml/tinyxmlparser.cpp
